...
| Arquivo | Formato | Para que serve na Hope?|
|---------|---------|---------------------|
...
| `produtos_financeiros.json` | JSON | Conhecer os produtos disponíveis paar que eles possam ser eensinados ao cliente. |
...
Para simplificar, podemos simplesente "injetar" os dados em nosso prompt, garantindo que o Agente tenha o melhor contexto possível, lembrando que em soluçoes mais robutsas o idela é essas informações sejam carrregadas dinamicamente para que possamos ganhar flexibilidade.
''' text
...
PRODUTOS DISPONÍVEIS PARA ENSINO(produtos_financeiros.json):
[
  {
    "nome": "Tesouro Selic",
...
O exemplo de contexto montado abaixo, se baseia nos dados originais da base de conhecimento , mas os sintetiza deixando apenas as informações mais relevantes, otimizando asssim o consumo de tokens. Entretanto, vale lembrar que mais importante que economizar tokens, é ter todas informações relevantes disponíveis em seu contexto.
